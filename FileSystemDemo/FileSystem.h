 ...
 * std::vector<std::string> files = Directory::getQueryFiles(path, pattern);
...
namespace FileSystem
{
  ...
  public:
    ...
    static std::vector<std::string> getQueryFiles(const std::string& path=".", const std::string& pattern="*.*");
