...
std::vector<std::string> Directory::getQueryFiles(const std::string& path, const std::string& pattern)
{
...
int main(int argc, char* argv[])
{
  ...
  std::cout << "\n  It contains files:";
  std::vector<std::string> currfiles = Directory::getQueryFiles();
  ///////////////////////////////////////////////////////
  // This works too
  // std::vector<std::string> currfiles = d.getQueryFiles();  
  ...
  currfiles = Directory::getQueryFiles("c:/temp/", "*.txt");
  ...
  std::vector<std::string> testFiles = Directory::getQueryFiles(testPath);
